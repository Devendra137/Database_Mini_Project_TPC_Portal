            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table class="table table-striped table-light">
                  ...
                  <tbody>
                    <?php
                      $query = "select company_name, count(rollno), max(ctc), min(ctc), avg(ctc) from prev_years where year >= $GLOBALS['start_year'] and year <= $GLOBALS['end_year'] group by company_name;";
