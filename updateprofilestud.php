...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $conn->query("update students set username='$username', age='$age', aoi='$aoi', class10='$class10', class12='$class12', sem1='$sem1', sem2='$sem2', sem3='$sem3', sem4='$sem4', sem5='$sem5', sem6='$sem6', sem7='$sem7', currentsem = '$currentsem',batchyear = '$batchyear' ,cpi = $cpi where rollno ='$rollno';");
...
<body>
    ...
    <div class="container my-4">
        ...
        <form method="post" action="updateprofilestud.php?rollno=<?= $GLOBALS["rollno"];
        ; ?>">
            <div class="form row">
                ...
                <div class="form-group col-md-6 ">
                    ...
                    <input type="text" class="form-control" id="rollno" name="rollno" aria-describedby="emailHelp"
                        value="<?php echo $rollno ?>" readonly>
                </div>
            </div>
            <div class="form row">
                <div class="form-group col-md-6">
